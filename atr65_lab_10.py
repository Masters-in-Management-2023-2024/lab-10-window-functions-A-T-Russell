...
Original file is located at
    https://colab.research.google.com/drive/1jMhequHiUwBQj_rdrpeHDm3sermbbiAv
...
# Print column names to help diagnose ColumnNotFoundError
print("Columns in strikes DataFrame after cleaning:")
...
running_total_strikes = strikes.with_columns(
    ...
    pl.col("date") <= dt.date(2013, 12, 31)
)
...
type_species = strikes.group_by("Aircraft: Type", "Wildlife: Species Group").agg(
    pl.sum("Cost: Total $").alias("damage")
).with_columns(
